...
@synthesize restEngine = _restEngine;
...
//    [[NSNotificationCenter defaultCenter] removeObserver:self name:kMKNetworkEngineOperationCountChanged object:nil];
    [super dealloc];
...
//                                             selector:@selector(handleOperationCountChanged:)
...
- (void)handleOperationCountChanged:(NSNotification *)notif {
    NSLog(@"剩余任务：%@",notif.object);
}
